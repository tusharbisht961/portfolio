const portfolioData = {
    ...
    "projects": [
        ...
        // },
        {
            ...
            "bulletPoints": [
                " To gain a new skill in frontend developer ",
                "Enhanced code quality using SonarQube and ESLint, leading to a 20% reduction in technical debt.",
                " Improve skill in react also study many things in react "
            ],
            "link": "http://127.0.0.1:5501/index.html#experience"
        }
    ],
    experience: [
        {
    ...
    contact: {
        ...
        socialLinks: [
            { platform: "Email", icon: "https://cdn.jsdelivr.net/npm/simple-icons@v5/icons/gmail.svg", url: "mailto:bishttushar355@gmail.com" },
            { platform: "LinkedIn", icon: "https://cdn.jsdelivr.net/npm/simple-icons@v5/icons/linkedin.svg", url: "https://www.linkedin.com/in/tushar-bisht-925901225/" },
            { platform: "GitHub", icon: "https://cdn.jsdelivr.net/npm/simple-icons@v5/icons/github.svg", url: "https://github.com/tusharbisht961" },
        ]
    }
};
